...
def main():
    ...
    print("Summary:")
    print(
        f"  Original:    {len(graph_original.nodes):3d} nodes, {len(graph_original.segments):3d} segments"
    )
    print(
        f"  Topological: {len(graph_topo.nodes):3d} nodes, {len(graph_topo.segments):3d} segments ({reduction_topo:.1f}% reduction)"
    )
    print(
        f"  Geometric:   {len(graph_geo.nodes):3d} nodes, {len(graph_geo.segments):3d} segments ({reduction_geo:.1f}% reduction)"
    )
    print()
    print("Use cases:")
